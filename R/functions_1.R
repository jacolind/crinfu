...
# todo this function does not solve the problem than one of the "upscaled" guys can get > 30. fix it by running iteratively a few times. 

wexample
w_rescale_minmax(wexample)
